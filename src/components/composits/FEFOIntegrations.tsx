...
const ALERT_COLOR = "text-primary";
const ALERT_ACCENT = "bg-primary";
        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          ...
          <div className="space-y-8 order-1 lg:order-1">
            <div className="space-y-4">
              <div
                className={`inline-flex items-center gap-2 px-3 py-1 rounded-full ${ALERT_ACCENT}/10 ${ALERT_COLOR} text-sm font-medium`}
              >
              ...
              <h2 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-5xl">
                ...
                <span className={ALERT_COLOR}>Location-Based FEFO</span>
              </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <div className={`p-2 rounded-full ${ALERT_ACCENT}/10 shrink-0`}>
                  <CalendarClock className={`h-5 w-5 ${ALERT_COLOR}`} />
                </div>
                <div>
                  <h4 className="font-semibold text-lg">Proactive Alerts</h4>
                  <p className="text-sm text-muted-foreground">
                    Generate reports identifying the exact rack slots containing
              ...
              <div className="flex items-start gap-4">
                <div className={`p-2 rounded-full ${ALERT_ACCENT}/10 shrink-0`}>
                  <Scan className={`h-5 w-5 ${ALERT_COLOR}`} />
                </div>
                <div>
            ...
            <div className="pt-4">
              <Button
                ...
                size="lg"
                className={`${ALERT_ACCENT} hover:${ALERT_ACCENT}/90 transition-colors`}
              >
